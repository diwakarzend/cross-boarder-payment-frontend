            ...
            <div className="container">
                <div className="top">
                    <div className="transaction-box">
                        ...
                        <Text color="color3" size="xl" fw="medium"><i className="fa fa-rupee" aria-hidden="true"></i> 5,300.00</Text>
                    </div>
                    <div className="transaction-box">
                        <Text color="color3" size="sm" fw="medium">Total Transactions :</Text>
                        <Text color="color3" size="xl" fw="medium"> 4</Text>
                    </div>
                </div>
            ...
            <div className="container">
                <div className="top">
                    <div className="transaction-box">
                        ...
                        <Text color="color3" size="xl" fw="medium"><i className="fa fa-rupee" aria-hidden="true"></i> 20,500.90</Text>
                    </div>
                    <div className="transaction-box">
                        <Text color="color3" size="sm" fw="medium">Total Transactions :</Text>
                        <Text color="color3" size="xl" fw="medium"> 35</Text>
                    </div>
                </div>
                <div className="payment-mode">
                    <div className="box">
