...
import BlockCardMaskModal from "./BlockCardMaskModal";
    ...
    return(
        <>
         ...
         <div className="flex title-wrapper space-between mb16">
                ...
                <Text  as="h4"  fs="20" fw="bold" color="color15"  style={{marginBottom:"14.5px",fontSize:"xl"}}>Block Card Mask</Text>
            ...
            <div className="upload-wrapper">
                <Text  as="h4"  fs="20" fw="bold" color="color15"  style={{marginBottom:"14.5px",fontSize:"xl"}}>Add Bulk Rules for Card Mask</Text>
         ...
         {isOpen ? <BlockCardMaskModal setIsOpen ={setIsOpen}/>:""}
        </>
    )
