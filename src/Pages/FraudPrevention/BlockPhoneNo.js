...
import BlockPhoneNumberModal from "./BlockPhoneNumberModal";
    ...
    return(
        <>
         ...
         <div className="flex title-wrapper space-between mb16">
                ...
                <Text  as="h4"  fs="20" fw="bold" color="color15"  style={{marginBottom:"14.5px",fontSize:"xl"}}>Block Phone Number</Text>
        ...
        {isOpen ? <BlockPhoneNumberModal setIsOpen ={setIsOpen}/>:""}
