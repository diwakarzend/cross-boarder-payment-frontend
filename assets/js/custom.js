(function($) {
	...
	$(".dropdown-menu li a").on('click',function () {
		$(this).parents(".dropdown").find('.btn').html($(this).html() + ' <span className="caret"></span>');
...
if($(".scroll_auto").length){
	...
	$(".todo--panel").on("submit", "form", function (a) {
		...
		$('<li className="list-group-item" style="display: none;"><label className="todo--label"><input type="checkbox" name="" value="1" className="todo--input"><span className="todo--text">' + c.val() + '</span></label><a href="#" className="todo--remove">&times;</a></li>').appendTo(".list-group").slideDown("slow");
		c.val("");
	...
	//Accordian for api section start
	var $this;
	var $target;
