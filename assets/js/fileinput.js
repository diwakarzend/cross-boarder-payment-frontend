...
(function ($) {
    var isIE = function(ver) {
        ...
        DEFAULT_PREVIEW = '<div className="file-preview-other">\n' +
            '       <i className="glyphicon glyphicon-file"></i>\n' +
            '   </div>';

    var defaultFileActionSettings = {
        removeIcon: '<i className="glyphicon glyphicon-trash text-danger"></i>',
        removeClass: 'btn btn-xs btn-default',
        removeTitle: 'Remove file',
        uploadIcon: '<i className="glyphicon glyphicon-upload text-info"></i>',
        uploadClass: 'btn btn-xs btn-default',
        uploadTitle: 'Upload file',
        indicatorNew: '<i className="glyphicon glyphicon-hand-down text-warning"></i>',
        indicatorSuccess: '<i className="glyphicon glyphicon-ok-sign file-icon-large text-success"></i>',
        indicatorError: '<i className="glyphicon glyphicon-exclamation-sign text-danger"></i>',
        indicatorLoading: '<i className="glyphicon glyphicon-hand-up text-muted"></i>',
    ...
    var defaultLayoutTemplates = {
        main1: '{preview}\n' +
        '<div className="kv-upload-progress hide"></div>\n' +
        ...
        '</div>',
        main2: '{preview}\n<div className="kv-upload-progress hide"></div>\n{remove}\n{cancel}\n{upload}\n{browse}\n',
        preview: '<div className="file-preview {class}">\n' +
        '    <div className="close fileinput-remove">&times;</div>\n' +
        '    <div className="{dropClass}">\n' +
        '    <div className="file-preview-thumbnails">\n' +
        '    </div>\n' +
        '    <div className="clearfix"></div>' +
        '    <div className="file-preview-status text-center text-success"></div>\n' +
        '    <div className="kv-fileinput-error"></div>\n' +
        '    </div>\n' +
        '</div>',
        icon: '<span className="glyphicon glyphicon-file kv-caption-icon"></span>',
        caption: '<div tabindex="-1" className="form-control file-caption {class}">\n' +
        '   <span className="file-caption-ellipsis">&hellip;</span>\n' +
        '   <div className="file-caption-name"></div>\n' +
        '</div>',
        modal: '<div id="{id}" className="modal fade">\n' +
        '  <div className="modal-dialog modal-lg">\n' +
        '    <div className="modal-content">\n' +
        '      <div className="modal-header">\n' +
        '        <button type="button" className="close" data-dismiss="modal" aria-hidden="true">&times;</button>\n' +
        '        <h3 className="modal-title">Detailed Preview <small>{title}</small></h3>\n' +
        '      </div>\n' +
        '      <div className="modal-body">\n' +
        '        <textarea className="form-control" style="font-family:Monaco,Consolas,monospace; height: {height}px;" readonly>{body}</textarea>\n' +
        '      </div>\n' +
        '    </div>\n' +
        '  </div>\n' +
        '</div>',
        progress: '<div className="progress">\n' +
        '    <div className="progress-bar progress-bar-success progress-bar-striped text-center" role="progressbar" aria-valuenow="{percent}" aria-valuemin="0" aria-valuemax="100" style="width:{percent}%;">\n' +
        '        {percent}%\n' +
        '     </div>\n' +
        '</div>',
        footer: '<div className="file-thumbnail-footer">\n' +
        '    <div className="file-caption-name" style="width:{width}">{caption}</div>\n' +
        '    {actions}\n' +
        '</div>',
        actions: '<div className="file-actions">\n' +
        '    <div className="file-footer-buttons">\n' +
        '        {upload}{delete}{other}' +
        '    </div>\n' +
        '    <div className="file-upload-indicator" tabindex="-1" title="{indicatorTitle}">{indicator}</div>\n' +
        '    <div className="clearfix"></div>\n' +
        '</div>',
        actionDelete: '<button type="button" className="kv-file-remove {removeClass}" title="{removeTitle}"{dataUrl}{dataKey}>{removeIcon}</button>\n',
        actionUpload: '<button type="button" className="kv-file-upload {uploadClass}" title="{uploadTitle}">{uploadIcon}</button>\n'
    };
    var defaultPreviewTypes = ['image', 'html', 'text', 'video', 'audio', 'flash', 'object'];
    var defaultPreviewTemplates = {
        generic: '<div className="file-preview-frame{frameClass}" id="{previewId}" data-fileindex="{fileindex}">\n' +
        '   {content}\n' +
        '   {footer}\n' +
        '</div>\n',
        html: '<div className="file-preview-frame{frameClass}" id="{previewId}" data-fileindex="{fileindex}">\n' +
        '    <object data="{data}" type="{type}" width="{width}" height="{height}">\n' +
        '       ' + DEFAULT_PREVIEW + '\n' +
        '    </object>\n' +
        '   {footer}\n' +
        '</div>',
        image: '<div className="file-preview-frame{frameClass}" id="{previewId}" data-fileindex="{fileindex}">\n' +
        '   <img src="{data}" className="file-preview-image" title="{caption}" alt="{caption}" ' + STYLE_SETTING + '>\n' +
        '   {footer}\n' +
        '</div>\n',
        text: '<div className="file-preview-frame{frameClass}" id="{previewId}" data-fileindex="{fileindex}">\n' +
        '   <div className="file-preview-text" title="{caption}" ' + STYLE_SETTING + '>\n' +
        '       {data}\n' +
        '   </div>\n' +
        '   {footer}\n' +
        '</div>\n',
        video: '<div className="file-preview-frame{frameClass}" id="{previewId}" data-fileindex="{fileindex}" title="{caption}" ' + STYLE_SETTING + '>\n' +
        ...
        '   {footer}\n' +
        '</div>\n',
        audio: '<div className="file-preview-frame{frameClass}" id="{previewId}" data-fileindex="{fileindex}" title="{caption}" ' + STYLE_SETTING + '>\n' +
        '   <audio controls>\n' +
        '       <source src="{data}" type="{type}">\n' +
        '       ' + DEFAULT_PREVIEW + '\n' +
        '   </audio>\n' +
        '   {footer}\n' +
        '</div>\n',
        flash: '<div className="file-preview-frame{frameClass}" id="{previewId}" data-fileindex="{fileindex}" title="{caption}" ' + STYLE_SETTING + '>\n' +
        '   <object type="application/x-shockwave-flash" width="{width}" height="{height}" data="{data}">\n' +
        OBJECT_PARAMS + '       ' + DEFAULT_PREVIEW + '\n' +
        '   </object>\n' +
        '   {footer}\n' +
        '</div>\n',
        object: '<div className="file-preview-frame{frameClass}" id="{previewId}" data-fileindex="{fileindex}" title="{caption}" ' + STYLE_SETTING + '>\n' +
        '    <object data="{data}" type="{type}" width="{width}" height="{height}">\n' +
        ...
        '   {footer}\n' +
        '</div>',
        other: '<div className="file-preview-frame{frameClass}" id="{previewId}" data-fileindex="{fileindex}" title="{caption}" ' + STYLE_SETTING + '>\n' +
        '   ' + DEFAULT_PREVIEW + '\n' +
        '   {footer}\n' +
        '</div>',
    };
    ...
    FileInput.prototype = {
        ...
        setFileDropZoneTitle: function() {
            ...
            if ($zone.find('.file-preview-frame').length == 0) {
                $zone.prepend('<div className="' + self.dropZoneTitleClass + '">' + self.dropZoneTitle + '</div>');
            }
        ...
        showUploadError: function (msg, data, previewId, index) {
            ...
            if ($error.find('ul').length == 0) {
                $error.html('<ul className="text-left"><li>' + msg + '</li></ul>');
            } else {
        ...
        previewDefault: function(file, previewId) {
            ...
            if (arguments.length > 2) {
                ...
                footer += '<div className="file-other-error text-danger"><i className="glyphicon glyphicon-exclamation-sign"></i></div>';
            }
        ...
        renderBrowse: function () {
            ...
            return '<div className="' + css + '"' + status + '> ' + self.browseIcon + self.browseLabel + ' </div>';
        },
        renderRemove: function () {
            ...
            return '<button type="button" title="' + self.removeTitle + '" className="' + css + '"' + status + '>' + self.removeIcon + self.removeLabel + '</button>';
        },
        renderCancel: function () {
            ...
            return '<button type="button" title="' + self.cancelTitle + '" className="hide ' + css + '">' + self.cancelIcon + self.cancelLabel + '</button>';
        },
        renderUpload: function () {
            ...
            if (!self.isUploadable || self.isDisabled) {
                content = '<button type="submit" title="' + self.uploadTitle + '"className="' + css + '"' + status + '>' + self.uploadIcon + self.uploadLabel + '</button>';
            } else {
                content = '<a href="' + self.uploadUrl + '" title="' + self.uploadTitle + '" className="' + css + '"' + status + '>' + self.uploadIcon + self.uploadLabel + '</a>';
            }
            return content;
        }
    }
    ...
    $.fn.fileinput.defaults = {
        ...
        browseIcon: '<i className="fa fa-folder-open"></i> &nbsp;',
        browseClass: 'btn btn-default',
        removeLabel: 'Remove',
        removeTitle: 'Clear selected files',
        removeIcon: '<i className="glyphicon glyphicon-trash"></i> ',
        removeClass: 'btn btn-default',
        cancelLabel: 'Cancel',
        cancelTitle: 'Abort ongoing upload',
        cancelIcon: '<i className="glyphicon glyphicon-ban-circle"></i> ',
        cancelClass: 'btn btn-default',
        uploadLabel: 'Upload',
        uploadTitle: 'Upload selected files',
        uploadIcon: '<i className="glyphicon glyphicon-upload"></i> ',
        ...
        msgValidationError: '<span className="text-danger"><i className="glyphicon glyphicon-exclamation-sign"></i> File Upload Error</span>',
        ...
        wrapTextLength: 250,
        wrapIndicator: ' <span className="wrap-indicator" title="{title}" onclick="{dialog}">[&hellip;]</span>',
