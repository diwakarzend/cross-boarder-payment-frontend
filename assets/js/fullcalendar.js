...
var DayTableMixin = /** @class */ (function (_super) {
    ...
    DayTableMixin.prototype.renderHeadHtml = function () {
        ...
        return '' +
            '<div className="fc-row ' + theme.getClass('headerRow') + '">' +
...
var DayGrid = /** @class */ (function (_super) {
    ...
    DayGrid.prototype.renderSegPopoverContent = function (row, col, segs) {
        ...
        var content = $('<div className="fc-header ' + theme.getClass('popoverHeader') + '">' +
            '<span className="fc-close ' + theme.getIconClass('close') + '"></span>' +
            '<span className="fc-title">' +
            util_1.htmlEscape(title) +
            '</span>' +
            '<div className="fc-clear"/>' +
            '</div>' +
            '<div className="fc-body ' + theme.getClass('popoverContent') + '">' +
...
var BasicView = /** @class */ (function (_super) {
    ...
    BasicView.prototype.renderSkeleton = function () {
        ...
        dayGridEl = $('<div className="fc-day-grid" />').appendTo(dayGridContainerEl);
    ...
    return /** @class */ (function (_super) {
        ...
        SubClass.prototype.renderHeadIntroHtml = function () {
            ...
            if (this.colWeekNumbersVisible) {
                return '' +
                    '<th className="fc-week-number ' + view.calendar.theme.getClass('widgetHeader') + '" ' + view.weekNumberStyleAttr() + '>' +
        ...
        SubClass.prototype.renderBgIntroHtml = function () {
            var view = this.view;
            if (this.colWeekNumbersVisible) {
                return '<td className="fc-week-number ' + view.calendar.theme.getClass('widgetContent') + '" ' +
...
var Calendar = /** @class */ (function () {
    ...
    Calendar.prototype.renderView = function (viewType) {
        ...
        if (!this.view && viewType) {
            ...
            newView.setElement($("<div className='fc-view fc-" + viewType + "-view' />").appendTo(this.contentEl));
...
var AgendaView = /** @class */ (function (_super) {
    ...
    AgendaView.prototype.renderSkeleton = function () {
        ...
        timeGridEl = $('<div className="fc-time-grid" />').appendTo(timeGridWrapEl);
    ...
    return /** @class */ (function (_super) {
        ...
        SubClass.prototype.renderHeadIntroHtml = function () {
            ...
            if (this.opt('weekNumbers')) {
                ...
                return '' +
                    '<th className="fc-axis fc-week-number ' + calendar.theme.getClass('widgetHeader') + '" ' + view.axisStyleAttr() + '>' +
                    view.buildGotoAnchorHtml(// aside from link, important for matchCellWidths
                ...
                return '<th className="fc-axis ' + calendar.theme.getClass('widgetHeader') + '" ' + view.axisStyleAttr() + '></th>';
            }
        };
        // Generates the HTML that goes before the bg of the TimeGrid slot area. Long vertical column.
        SubClass.prototype.renderBgIntroHtml = function () {
            var view = this.view;
            return '<td className="fc-axis ' + view.calendar.theme.getClass('widgetContent') + '" ' + view.axisStyleAttr() + '></td>';
        };
...
function makeDayGridSubclass(SuperClass) {
    return /** @class */ (function (_super) {
        ...
        SubClass.prototype.renderBgIntroHtml = function () {
            var view = this.view;
            return '' +
                '<td className="fc-axis ' + view.calendar.theme.getClass('widgetContent') + '" ' + view.axisStyleAttr() + '>' +
                '<span>' + // needed for matchCellWidths
                view.getAllDayHtml() +
                '</span>' +
                '</td>';
...
var TimeGrid = /** @class */ (function (_super) {
    ...
    TimeGrid.prototype.renderSkeleton = function () {
        var theme = this.view.calendar.theme;
        this.el.html('<div className="fc-bg"></div>' +
            '<div className="fc-slats"></div>' +
            '<hr className="fc-divider ' + theme.getClass('widgetHeader') + '" style="display:none" />');
    ...
    TimeGrid.prototype.renderSlatRowHtml = function () {
        ...
        while (slotTime < dateProfile.maxTime) {
            ...
            axisHtml =
                '<td className="fc-axis fc-time ' + theme.getClass('widgetContent') + '" ' + view.axisStyleAttr() + '>' +
                    (isLabeled ?
    ...
    TimeGrid.prototype.renderColumns = function () {
        ...
        this.el.find('> .fc-bg').html('<table className="' + theme.getClass('tableGrid') + '">' +
    ...
    TimeGrid.prototype.renderContentSkeleton = function () {
        ...
        skeletonEl = this.contentSkeletonEl = $('<div className="fc-content-skeleton">' +
            '<table>' +
            '<tr>' + cellHtml + '</tr>' +
            '</table>' +
            '</div>');
...
var ListView = /** @class */ (function (_super) {
    ...
    ListView.prototype.renderEmptyMessage = function () {
        this.contentEl.html('<div className="fc-list-empty-wrap2">' + // TODO: try less wraps
    ...
    ListView.prototype.renderSegList = function (allSegs) {
        ...
        var daySegs;
        var i;
        var tableEl = $('<table className="fc-list-table ' + this.calendar.theme.getClass('tableList') + '"><tbody/></table>');
    ...
    ListView.prototype.dayHeaderHtml = function (dayDate) {
        ...
        return '<tr className="fc-list-heading" data-date="' + dayDate.format('YYYY-MM-DD') + '">' +
            '<td className="' + this.calendar.theme.getClass('widgetHeader') + '" colspan="3">' +
            (mainFormat ?
...
var Toolbar = /** @class */ (function () {
    ...
    Toolbar.prototype.render = function () {
        ...
        if (sections) {
            if (!el) {
                el = this.el = $("<div className='fc-toolbar " + this.toolbarOptions.extraClasses + "'/>");
            }
            else {
                el.empty();
            }
...
var DayGridEventRenderer = /** @class */ (function (_super) {
    ...
    DayGridEventRenderer.prototype.fgSegHtml = function (seg, disableResizing) {
        ...
        if (seg.isStart) {
            timeText = this.getTimeText(seg.footprint);
            if (timeText) {
                timeHtml = '<span className="fc-time">' + util_1.htmlEscape(timeText) + '</span>';
            }
        }
        titleHtml =
            '<span className="fc-title">' +
...
var DayGridFillRenderer = /** @class */ (function (_super) {
    ...
    DayGridFillRenderer.prototype.renderFillRow = function (type, seg) {
        ...
        skeletonEl = $('<div className="fc-' + className + '-skeleton">' +
            '<table><tr/></table>' +
            '</div>');
